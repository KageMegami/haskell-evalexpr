...
/* package funEvalExpr-0.1.0.0 */
#ifndef VERSION_funEvalExpr
#define VERSION_funEvalExpr "0.1.0.0"
#endif /* VERSION_funEvalExpr */
#ifndef MIN_VERSION_funEvalExpr
#define MIN_VERSION_funEvalExpr(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_funEvalExpr */
...
#define CURRENT_PACKAGE_KEY "funEvalExpr-0.1.0.0-H1elcHzCFtz2rmjCTCuNj6"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "funEvalExpr-0.1.0.0-H1elcHzCFtz2rmjCTCuNj6"
